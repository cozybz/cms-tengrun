   ...
   <div id="pageB" style="height:300px; margin-top:3px;float: left">
    ...
    <div id="pageC"  style="border:1px solid #099;margin-top:3px;margin-left:5px;width: 723px;height:566px;background:u#f6f7f8;float: left;">
	       ...
	       <div style="width: 723px;height: 30px;background-image:url(images/zhuti.jpg); " >
	      			<div style="font-weight:bold; margin-left: 22px;padding-top: 5px;"><p>${requestScope.product.getProductType()}</p></div>
		    </div>
	    
	    
	    

	    		<div style="width: 723px;height:60px;border-bottom: solid 3px #6d9ed0;"><center><h1 style="padding-top:20px; ">${requestScope.product.getName()}</h1></center></div>
	    		<div style="width: 723px;padding-top:10px;;height:471px;border-bottom: solid 1px #6d9ed0;">
	    		<c:if test="${requestScope.product.getProductType()!='新闻'}">
	    		<center><img height="380px" width="650px;" src="${requestScope.product.getImgUrl()}" /></center>
	    		</c:if>
	    		${requestScope.product.getInformation()}
	    		</div>
