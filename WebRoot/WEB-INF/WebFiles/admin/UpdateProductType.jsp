  ...
  <div style="width:960px; background: #999; margin:0 auto;">
        ...
        <div style=" width:750px; height:450px; background-color:#F2F2F2; margin-left:5px; float:left;">
        	<div style=" background: url(images/zhuti.jpg); width:750px; height:30px;">
            	...
            	<div style="width:90px; height:30px; margin-left:35px; font-weight:bold; padding-top:10px;">修改产品分类</div></div>
            	<div style="margin:150px 250px;">
<form action="admin/UpdateProductType_do" method="post">
<table>
<tr>
<td>板块id</td>
<td>${requestScope.productType.getId() }</td>
</tr>
<tr>
<td>板块名：</td>
<td><input type="text" value="${requestScope.productType.getProductType() }" name="name" ></td>
</tr>

<tr>
<td colspan="2">
<input type="hidden" value="${requestScope.productType.getId() }" name="id">
