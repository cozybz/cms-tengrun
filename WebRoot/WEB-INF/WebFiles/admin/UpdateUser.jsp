  ...
  <div style="width:960px; background: #999; margin:0 auto;">
        ...
        <div style=" width:750px; height:450px; background-color:#F2F2F2; margin-left:5px; float:left;">
        	<div style=" background: url(images/zhuti.jpg); width:750px; height:30px;">
            	...
            	<div style="width:90px; height:30px; margin-left:35px; font-weight:bold; padding-top:10px;">修改用户</div>
            	</div>
            	<div style="margin:100px 250px;">
  <form action="admin/UpdateUser_do" method="post" onsubmit="return Validate()">
<table>
<tr>
<td>用户id</td>
...
<tr>
<td colspan="2">
<input type="hidden" value="${requestScope.user.getId()}" name="id">
