...
stripeTable(); highlightRows(); } 
  ...
  <div style="width:960px; background: #999; margin:0 auto;">
        ...
        <div style=" width:750px; height:450px; background-color:#F2F2F2; margin-left:5px; float:left;">
        	...
        	<div style="width:90px; height:30px; margin-left:35px; font-weight:bold; padding-top:10px;">用户管理</div>
            </div>
...
<c:forEach var="user" items="${requestScope.all}" >
	...
	<td><a href="admin/UpdateUser?id=${user.getId()}">修改</a></td>
	<td><c:if test="${user.getId()!=1}"><a href="admin/DeleteUser?id=${user.getId()}">删除</a></c:if></td>
	</tr>
</c:forEach>
</table>  
